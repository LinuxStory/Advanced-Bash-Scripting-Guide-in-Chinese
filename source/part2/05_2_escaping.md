...
ABC=$'\101\102\103\010'           # 101，102，103是 A, B, C 的ASCII码的八进制形式。
echo $ABC
...
# 如果我们转义了这些空格会怎样？
ls -l /usr/X11R6/bin/xsetroot\ /sbin/dump\ $file_list
# 错误：因为转移了两个空格，因此前三个文件被连接成了一个参数传递给了 'ls -l'
```
...
# 复制 Alan Cox 的复制文件夹命令，但是把它拆成了两行。
